    ...
    TreasuryV1_1Storage
{
    ...
    */
    ...
    function setClaimPause(bool _pause) external onlyPolicyOwner {

        require(claimPause != _pause, "same");
    ...
    function setClaimableStartTime(uint32 _startTime) external onlyPolicyOwner {
        ...
        emit SetClaimableStartTime(_startTime);
    }
    ...
    function claimableEther(uint256 tosAmount) public view returns (uint256 ethAmount_) {
