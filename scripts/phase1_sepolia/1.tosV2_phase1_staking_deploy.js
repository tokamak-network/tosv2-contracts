...
async function main() {
    ...
    printGasUsedOfUnits('LibStaking Deploy', chainId, tx);
    ...
    printGasUsedOfUnits('stakingProxy Deploy', chainId, tx);
    ...
    if(chainId == 1 || chainId == 4 || chainId == 5 || chainId == 17000 || chainId == 11155111) {
      await run("verify", {
        address: stakingLogic.address,
        constructorArgsParams: [],
      });
