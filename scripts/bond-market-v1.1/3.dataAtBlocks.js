...
async function main() {
    ...
    let lockTOSAbi = require('../../abis/LockTOSv2Logic0.json');
    //totalSupply
    ...
    */
    ...
    const lockTOSContract = new ethers.Contract(lockTOsAddress, lockTOSAbi.abi, ethers.provider);

    let totalSupply = await lockTOSContract.totalSupply();
