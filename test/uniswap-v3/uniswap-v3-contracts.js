...
const NFTDescriptorLibraryJson = require("../../abis/NFTDescriptor.json");
const NonfungiblePositionManagerJson = require("../../abis/NonfungiblePositionManager.json");
const NonfungibleTokenPositionDescriptor = require("../../abis/NonfungibleTokenPositionDescriptor.json");
const SwapRouterJson = require("../../abis/SwapRouter.json");
const PoolAddressJson = require("../../abis/PoolAddress.json");
...
const deployedUniswapV3Contracts = async () => {
