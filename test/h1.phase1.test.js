  ...
  */
    ...
    if(firstExcute == false) {
      ...
      */
      ...
      it("lockTOSProxy upgrade", async () => {
        ...
        await lockTosContract.connect(admin1).upgradeTo(lockTOSProxy2Address);
      ...
      it("lockTOSProxy2 setimpletation", async () => {
        await lockTosContract.connect(admin1).setImplementation2(lockTOSLogic2Address, 0, true);
      })
  ...
  describe("#3-1. bondDepository function test", async () => {
    ...
    it("#3-1-2. ETHDeposit : overDeposit situation, fail", async () => {
        // 1번에 구매 가능한양 TOS * Token/TOS = Token
    ...
    it("#3-1-3. ETHDeposit : fail, The minting amount cannot be less than the staking amount (TOS evaluation amount).", async () => {
